...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	if ($update) {
		...
		$sql = "INSERT INTO supir VALUES (NULL, '$_POST[nama]', '$_POST[telp]', '$_POST[alamat]', '$_POST[status]',1)";
	}
...
if (isset($_GET['action']) AND $_GET['action'] == 'delete') {
	$connection->query("UPDATE supir SET isActive=0 WHERE id_supir='$_GET[key]'");
	echo alert("Berhasil!", "?page=supir");
}
?>
<div class="row">
		...
		<div class="panel panel-info">
			...
			<div class="panel-body">
				<table class="table table-condensed">
					...
					<tbody>
						<?php $no = 1; ?>
						<?php if ($query = $connection->query("SELECT * FROM supir WHERE isActive=1")): ?>
