...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	if ($update) {
		$sql = "UPDATE pelanggan SET nama='$_POST[nama]', email='$_POST[email]', no_telp='$_POST[no_telp]' , alamat='$_POST[alamat]' , username='$_POST[username]'";
		if ($_POST["password"] != "") {
...
if (isset($_GET['action']) AND $_GET['action'] == 'delete') {
	$connection->query("UPDATE pelanggan SET isActive=0 WHERE id_pelanggan='$_GET[key]'");
	echo alert("Berhasil!", "?page=pelanggan");
}
?>
<div class="row">
		...
		<div class="panel panel-info">
			...
			<div class="panel-body">
				<table class="table table-condensed">
					...
					<tbody>
						<?php $no = 1; ?>
						<?php if ($query = $connection->query("SELECT * FROM pelanggan WHERE isActive=1")): ?>
