...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	if ($update) {
		...
		$sql = "INSERT INTO jenis VALUES (NULL, '$_POST[nama]',1)";
	}
...
if (isset($_GET['action']) AND $_GET['action'] == 'delete') {
	$connection->query("UPDATE jenis SET isActive=0 WHERE id_jenis='$_GET[key]'");
	echo alert("Berhasil!", "?page=jenis");
}
?>
<div class="row">
		...
		<div class="panel panel-info">
			...
			<div class="panel-body">
				<table class="table table-condensed">
					...
					<tbody>
						<?php $no = 1; ?>
						<?php if ($query = $connection->query("SELECT * FROM jenis  WHERE isActive=1")): ?>
