        ...
        <nav class="navbar " style="background-image: linear-gradient(180deg,#6b3434 10%,#f38888 100%); }">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <li>
                     <li><a href="?page=lap_konfirmasi">Laporan <span class="sr-only">(current)</span></a></li>
                </li>
                <li><a href="logout.php">Logout</a></li>
                <li><a href="#">|</a></li>
                <li><a href="#" style="font-weight: bold; color: aqua;"><?= ucfirst($_SESSION["admin"]["nama"]) ?></a></li>
            </ul>
        </div><!-- /.navbar-collapse -->
    </div><!-- /.container-fluid -->
</nav>
